...
summary: "How PFO collects, stores, uses and shares your personal data."
section: governance
order: 1
lastReviewed: 2019-02-08
---

This page summarises PFO's privacy policy.
...
(See separate British Orienteering Federation Limited Privacy Statement.) [Link to BOF Statement](https://www.britishorienteering.org.uk/document/e8d40ed3418ce3e1b50af592984ba3a0/British%20Orienteering%20Privacy%20Policy%2013%20March%202018.pdf).

## What data we will collect

In becoming a member of PFO, certain information about you will be collected. This will include your name, year of birth, gender, URN number (membership number), email address, address, telephone number, competition age class, competition results, skills and qualifications, and details of any coaching or officiating licences you hold (Membership Data).

Contact data is held for landowners and other partner organisations with which we co-operate, their employees, agents and tenants.
...
| --- | --- |
| Membership Data | Four years after an individual has not played an active part in the sport. |
...
If you have any concerns or complaints in relation to how PFO collects and/or processes your personal data, you should contact PFO's Data Protection Officer in the first instance. If you are dissatisfied with how your concern or complaint is dealt with by PFO, you have the right to report your concern or complaint to the [Information Commissioner's Office](https://www.ico.org.uk).

### Cookies

Cookies are small text files that are placed on your computer by websites that you visit. They are widely used in order to make websites work, or work more efficiently. This website **does not use them** for normal visitors, only for logged-in members administering the site.

Some cookies may be set by third parties, like YouTube, if for example a video has been embedded in a news item.
